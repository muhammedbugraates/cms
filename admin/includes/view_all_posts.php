...
<form action="" method='post'>
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            //if isset session username returned else false
            $user = currentUser();
            ...
            <?php
                ...
                echo "<td><img width='100' src='" . imageController($post_image) . "' alt='image'></td>";
                ...
                //js in onClick! are you sure alert..
...
//                echo "<td><a rel='$post_id' class='delete_link' href='javascript:void(0)'>Delete</a></td>";
                ...
                //oldest
                //                echo "<td><a onClick=\"javascript: return confirm('Are you sure? Do you want to delete?');\" href='posts.php?delete={$post_id}'>Delete</a></td>";
