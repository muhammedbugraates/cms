                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div class='huge'>
                                            <?php echo $post_count = count_records(get_all_user_posts());?>
                                        </div>
                                        <div>Posts</div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class='huge'>
                                            <?php echo $comment_count = count_records(get_all_posts_user_comments());?>
                                        </div>
                                        <div>Comments</div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class='huge'>
                                            <?php echo $category_count = count_records(get_all_user_categories());?>
                                        </div>
                                        <div>Categories</div>
                                    </div>
                                </div>
